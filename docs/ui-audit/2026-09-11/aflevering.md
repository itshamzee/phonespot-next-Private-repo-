...
7. Tilbehørets offentlige GET-projektion må rettes snævert: ingen indkøbspris i svaret, ingen opdigtede 99 enheder, ingen dobbeltoptælling og kun fysiske butikker i butiksfilteret. Forkerte antagelser om lagerkontrakten kan kræve korrektion efter stagingkontrol; interne tabeller og administrative flows ændres ikke.
...
10. Tilbehørsdata får en udtrykkelig offentlig feltliste ved tre eksisterende server/client-grænser: tilbehørsprodukt, refurbished-produkt og generisk produkt. Indkøbspris og leverandør-id må ikke sendes med blot fordi klienttypen er smallere. Et manglende nødvendigt UI-felt kan kræve tilføjelse til listen; interne queries og typer bevares.
