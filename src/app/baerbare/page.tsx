...
const FAQS: CollectionFaq[] = [
  ...
  { question: "Hvordan får jeg oplysninger om batteriet?", answer: "Se oplysningerne for den konkrete enhed på produktsiden. Batteriet vurderes særskilt og kan ikke udledes af den kosmetiske stand." },
...
const CHOICES = [
  ...
  { title: "Lager og stand", body: "Vælg plads til dine filer, og brug standen til at afstemme de kosmetiske brugsspor med dit budget." },
];
...
export default async function BaerbarePage({ searchParams }: { searchParams: Promise<{ brand?: string | string[] }> }) {
  ...
  return <>
    ...
    <DeviceCollection deviceType="laptop" templates={templates} initialBrand={initialBrand} title="Refurbished bærbare" intro="En ny arbejdsdag kræver ikke en ny computer. Find din næste MacBook eller bærbare, og sammenlign skærm, RAM og lagerplads med det, du skal bruge den til." collectionHeading="Aktuelle bærbare" guideTitle="Sådan vælger du bærbar" guideIntro="Start med dine programmer og den måde, computeren skal bruges på. Filtrene hjælper dig videre til de modeller, der matcher." choices={CHOICES} faqs={FAQS} serviceLink={{ href: "/reparation/macbook", label: "Se MacBook-reparationer", body: "Har din nuværende MacBook brug for hjælp, kan du se de aktuelle reparationer og vælge model." }} />
  </>;
}
