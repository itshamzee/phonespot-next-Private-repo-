        ...
        <Section title="Billeder">
          ...
          >
            ...
            <p className="text-sm text-charcoal/50">
              <span className="font-semibold text-emerald-600">Upload billeder</span> eller træk hertil
            </p>
          ...
          {/* Manual URL input */}
          <div className="mt-4">
            <Field label="Eller indsæt billed-URLs" hint="En URL per linje — tilføjes efter uploadede filer">
              <textarea
                value={imageUrls}
