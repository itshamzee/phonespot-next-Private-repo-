...
export default function SkuPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      {/* Redirect banner for spare parts */}
      <div className="flex flex-col gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-6 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm font-bold text-emerald-900">
              Reservedele administreres i den nye sektion
            </p>
            <p className="mt-0.5 text-sm text-emerald-700">
              Denne side er kun til tilbehoer og aeldre SKU-produkter. Opret og rediger reservedele via Reservedele-sektionen for kvalitetsniveauer, farvevarianter og bedre lagerstyring.
            </p>
          </div>
        </div>
        <div className="flex flex-shrink-0 gap-2 sm:flex-col">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90"
          >
            Se alle reservedele
