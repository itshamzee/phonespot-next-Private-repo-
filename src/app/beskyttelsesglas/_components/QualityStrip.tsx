...
const items = [
  {title:"Klart glas eller indkigsbeskyttelse",desc:"Vælg mellem de varianter, der er tilgængelige til din model. Se glassets egenskaber ved dit valg.",img:"/spot/clarity.png"},
