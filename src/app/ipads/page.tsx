...
const FAQS: CollectionFaq[] = [
  ...
  { question: "Hvad fortæller standen?", answer: "Stand A, B og C beskriver de kosmetiske brugsspor. Funktioner og den konkrete enheds oplysninger fremgår af produktsiden." },
  { question: "Hvordan vurderes batteriet?", answer: "Batteriet vurderes for den enkelte enhed. Den tilgængelige batterioplysning står på produktsiden og kan ikke udledes af den kosmetiske stand." },
