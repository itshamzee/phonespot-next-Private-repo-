...
const QUALITY_FAQ = [
  ...
  { question: "Er Grade N også refurbished?", answer: "Nej. Grade N er en fabriksny enhed, som er forseglet og aldrig brugt. Grade P er refurbished i premium stand med minimale eller ingen brugsspor." },
    ...
    <div className={styles.shell}>
      ...
      <div className={styles.container}>
        ...
        <section id="stand" className={styles.section}>
          <div className={styles.grid}>
            <div><h2>Standen handler om det, du kan se.</h2><p className={styles.intro}>Graden beskriver de kosmetiske brugsspor. De refurbished grader er testet for funktion, mens batteriet vurderes separat. De tilgængelige grader fremgår ved den enkelte model.</p><div className={styles.notice} style={{ marginTop: 24 }}><h3>{GRADE_SHORT_LABEL.N} · Grade N</h3><p>En forseglet enhed, som aldrig har været brugt. Grade N er ny og sælges derfor ikke som refurbished.</p></div></div>
