...
const FAQS: CollectionFaq[] = [
  { question: "Hvordan vælger jeg smartwatch?", answer: "Start med urstørrelse, de funktioner du bruger, og kompatibilitet med din telefon. Sammenlign derefter de aktuelle modeller og enheder." },
  { question: "Hvad betyder standen?", answer: "Graden beskriver kosmetiske brugsspor på ur og kabinet. Se den konkrete enhed for de oplysninger og billeder, der er tilgængelige." },
