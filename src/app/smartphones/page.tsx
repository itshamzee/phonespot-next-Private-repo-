...
export default async function SmartphonesPage() {
  ...
  return (
    <>
      ...
      <section className="bg-[#F7F7F8] border-b border-[#E5E5EA]">
        <div className="mx-auto max-w-7xl px-4 pt-3 pb-4 sm:pt-6 sm:pb-7">
          ...
          <p className="mt-1 text-[13px] sm:text-sm text-[#6E6E73]">
            {templates.length} {templates.length === 1 ? "model" : "modeller"} · Samsung, OnePlus, Google Pixel m.fl. · 36 mdr. garanti
          </p>
        </div>
      </section>
      ...
      <section className="bg-white border-b border-[#E5E5EA]">
        <div className="mx-auto max-w-7xl px-4 py-2.5 sm:py-4">
          <ul className="grid grid-cols-2 gap-x-3 gap-y-2.5 sm:grid-cols-4 sm:gap-x-4 sm:gap-y-3 text-sm">
            {[
              {
                label: "Ulåste & klar til brug",
                sub: "Virker med alle danske operatører",
      ...
      {/* ── All smartphones grid with sidebar filters ── */}
      <section className="bg-white py-4 sm:py-10 md:py-14">
        <div className="mx-auto max-w-7xl px-4">
          <FilteredGrid
            templates={templates}
            heading="Alle smartphones på lager"
            ...
            <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:gap-6 sm:text-left">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1.5 text-sm text-[#6E6E73] leading-relaxed">
                  Spørgsmål om en bestemt model, batteri-kapacitet eller danske operatører?
      ...
      <SectionWrapper background="sand">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-[#86868B]">
            Alle smartphones er 100% funktionelle. Forskellen mellem
      ...
      <SectionWrapper background="cream">
        <div className="grid items-center gap-6 sm:gap-12 lg:grid-cols-2">
          <div>
            ...
            <Heading as="h2" size="md">Hvorfor købe en refurbished smartphone?</Heading>
            <p className="mt-4 text-[#86868B] leading-relaxed">
              En ny Samsung Galaxy S-flagship koster fra 8.000 kr. Den samme
              model fås fra langt mindre hos PhoneSpot — testet med 30+
              kontroller og med 36 måneders garanti.
            </p>
            <ul className="mt-6 space-y-3">
              {[
                "Spar 20-50% sammenlignet med ny pris",
                "Samme Android, samme apps, samme hastighed",
                "80% mindre CO2 end ny produktion",
                "36 måneders garanti og 14 dages returret",
                "Ulåste — virker med alle danske operatører",
              ].map((point) => (
      ...
      <SectionWrapper>
        <div className="mx-auto max-w-3xl text-center">
          <Heading as="h2" size="md">Spørgsmål om refurbished smartphones</Heading>
        </div>
      ...
      <SectionWrapper>
        <div className="mx-auto max-w-2xl text-center">
          <Heading as="h2" size="md">Klar til at finde din næste telefon?</Heading>
          <p className="mt-4 text-[#86868B]">
