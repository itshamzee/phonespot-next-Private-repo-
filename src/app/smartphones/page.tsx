...
export const metadata: Metadata = {
  ...
  description: "Sammenlign aktuelle refurbished smartphones efter mærke, pris, lagerplads, stand og tilgængelighed.",
  alternates: { canonical: "https://phonespot.dk/smartphones" },
  openGraph: { title: "Refurbished smartphones | PhoneSpot", description: "Find en kvalitetstestet smartphone i det aktuelle udvalg.", url: "https://phonespot.dk/smartphones" },
};
...
export default async function SmartphonesPage() {
  ...
  return <>
    ...
    <DeviceCollection templates={templates} title="Refurbished smartphones" intro="Sammenlign det aktuelle udvalg af smartphones efter mærke, pris, lagerplads, stand og hvor enheden er på lager." collectionHeading="Aktuelle smartphones" guideTitle="Sådan vælger du smartphone" guideIntro="Tag udgangspunkt i de funktioner, der betyder mest i din hverdag. Vælg derefter blandt de konkrete modeller og enheder på lager." choices={CHOICES} faqs={FAQS} serviceLink={{ href: "/reparation", label: "Find din reparation", body: "Har din nuværende telefon brug for hjælp, kan du vælge mærke og model i vores reparationsoversigt." }} />
  </>;
}
