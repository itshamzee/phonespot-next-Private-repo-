...
const FAQS: CollectionFaq[] = [
  ...
  { question: "Hvad betyder Grade A, B og C?", answer: "Graden beskriver den kosmetiske stand og mængden af synlige brugsspor. Enhedens konkrete stand og billeder fremgår af produktsiden." },
  { question: "Hvordan er batteriet på en refurbished iPhone?", answer: "Batteriet vurderes på den enkelte enhed. Se den målte batterioplysning på produktsiden; den kosmetiske grade bruges ikke som mål for batteriet." },
