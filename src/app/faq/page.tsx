...
const sections = [
  {
    ...
    items: [
      ...
      { question: "Hvilken stand er jeres enheder i?", answer: "Grade P er premium stand med minimale eller ingen brugsspor. Grade A fremstår som ny. Grade B har lette brugsspor, og Grade C har synlige brugsspor. Grade N er fabriksny og er ikke refurbished. Se de tilgængelige grader ved den enkelte model." },
