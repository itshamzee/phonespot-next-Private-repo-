                ...
                <form onSubmit={handleSubmit} className={styles.panel} aria-label="Kontaktformular" aria-busy={status === "submitting"}>
                  ...
                  <fieldset disabled={status === "submitting"} className="space-y-5 border-0 p-0">
                    ...
                    <div className="grid gap-5 sm:grid-cols-2">
                      ...
                      <FormField label="E-mail" name="email" type="email" required autoComplete="email" placeholder="din@email.dk" value={formData.email} onChange={handleChange} />
                    </div>
                  ...
                  {status === "error" && <p role="alert" className="mt-5! rounded-lg bg-red-50 p-4 text-sm text-red-800!">Beskeden kunne ikke sendes. Dine oplysninger er gemt her i formularen. Prøv igen, eller kontakt os på telefon eller e-mail.</p>}
