    ...
    filters: [
      {
        ...
        type: "links",
        options: [
          { value: "Wallet", label: "Pungcover" },
          { value: "Book", label: "Bogcover" },
          { value: "Slim", label: "Slankt" },
          { value: "Clear", label: "Gennemsigtigt" },
          { value: "Rugged", label: "Forstærket" },
          { value: "Flip", label: "Flipcover" },
          { value: "Bumper", label: "Kantcover" },
        ],
      },
    ],
  },
    ...
    filters: [
      {
        ...
        type: "links",
        options: [
          { value: "Hærdet glas", label: "Beskyttelsesglas" },
          { value: "Film", label: "Beskyttelsesfilm" },
          { value: "Privacy", label: "Glas med indkigsbeskyttelse" },
          { value: "Edge to Edge", label: "Kant til kant" },
        ],
      },
    ],
  },
    ...
    filters: [
      {
        ...
        type: "links",
        options: [
          { value: "earbuds", label: "Øretelefoner og in-ear" },
          { value: "over-ear", label: "Hovedtelefoner og headsets" },
    ...
    filters: [
      {
        ...
        options: [
          ...
          { value: "magsafe", label: "MagSafe-holdere" },
        ],
      },
    ],
  },
