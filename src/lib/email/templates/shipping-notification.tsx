      ...
      <Body style={bodyStyle}>
        ...
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            ...
            <Text style={headlineStyle}>Din ordre {orderNumber} er afsendt</Text>
              ...
              <tbody>
                <tr>
                  <td style={trackingCardInnerStyle}>
                    ...
                    <p style={trackingLabelStyle}>Estimeret levering</p>
                    <p style={trackingDeliveryStyle}>
            ...
            {/* Items list */}
            <Text style={sectionLabelStyle}>Varer i din ordre</Text>
            <table
              width="100%"
              cellPadding={0}
              cellSpacing={0}
              style={itemsTableStyle}
            >
              <tbody>
                {items.map((item, index) => (
                  <tr key={index}>
                    <td style={itemQtyStyle}>{item.quantity}&times;</td>
                    <td style={itemTitleStyle}>{item.title}</td>
                  </tr>
                ))}
              </tbody>
            </table>
