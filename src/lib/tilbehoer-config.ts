...
export const TILBEHOER_DEVICES: TilbehoerDevice[] = [
  ...
  { slug: "iphone-16-plus", label: "iPhone 16 Plus", brand: "apple" },
  ...
  { slug: "iphone-15-plus", label: "iPhone 15 Plus", brand: "apple" },
  ...
  { slug: "iphone-14-plus", label: "iPhone 14 Plus", brand: "apple" },
