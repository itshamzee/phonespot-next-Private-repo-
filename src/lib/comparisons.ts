   ...
   * ------------------------------------------------------------------ */
  {
    ...
    rows: [
      ...
      },
      {
        ...
        competitor: "Brugt: Lavt CO\u2082-aftryk / Ny: Højt CO\u2082-aftryk",
      },
      {
        feature: "Risiko",
      ...
      {
        feature: "Tilstand",
        phonespot: "Testet og vurderet (A/B/C)",
        competitor: "Brugt: Ukendt / Ny: Perfekt",
      },
    ],
    verdict:
      "Refurbished er den optimale mellemvej for de fleste forbrugere. Du får en professionelt testet enhed i kendt tilstand med op til 36 måneders garanti \— til en pris, der typisk ligger 20\u201340% under nyprisen. Samtidig gør du et aktivt valg for miljøet ved at forlænge enhedens levetid. Køb af brugte enheder fra private kan være billigere, men risikoen er høj, og du står uden garanti. Nyt er det sikreste valg kvalitetsmæssigt, men du betaler fuld pris og bidrager til højere CO\u2082-udledning. Med refurbished fra PhoneSpot får du det bedste fra begge verdener.",
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          "Funktionelt ja. Alle refurbished enheder fra PhoneSpot gennemgår 30+ tests for at sikre, at de fungerer som nye. Kosmetisk kan der være lette brugsspor afhængigt af graderingen (A, B eller C), men funktionaliteten er fuldt på højde med nye enheder.",
      },
      {
