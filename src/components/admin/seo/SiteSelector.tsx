  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2.5 rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-sm font-medium text-zinc-200 transition-colors hover:border-zinc-700 hover:bg-zinc-800"
      >
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute left-0 top-full z-20 mt-1 w-64 overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900 py-1 shadow-xl shadow-black/40">
            {sites.map((site) => (
              <button
                key={site.id}
