...
function AccessoryProductDetails({
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      {/* ---- Statutory rights note. This is NOT a PhoneSpot guarantee — it's
              the mandatory reklamationsret (købeloven) and fortrydelsesret
              (forbrugeraftaleloven) every trader must honour by law. Calling
              a customer's statutory rights a trader "garanti" is itself
              misleading under markedsføringsloven §§5-6, so the heading and
              copy here must never use "garanti" — see TrustBar/ProductInfo
              variant="accessory" for the (correctly worded) short-form
