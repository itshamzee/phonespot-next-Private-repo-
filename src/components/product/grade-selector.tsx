...
> = {
  N: {
    ...
    tooltip:
      "Fabriksny: Enheden er helt ny og uåbnet i originalemballage med fuld producentgaranti.",
    color: "text-blue-600",
    bg: "bg-blue-500/10",
    badge: "NY",
  },
  ...
  A: {
    ...
    tooltip:
      "Stand A: Enheden er i perfekt stand uden synlige ridser eller mærker. Fremstår som ny. Batterikapaciteten er målt for den enkelte enhed og fremgår på produktsiden.",
  ...
  B: {
    ...
    tooltip:
      "Stand B: Enheden har lette brugsspor som små ridser. Fuldt funktionel og i god stand.",
  ...
  C: {
    ...
    tooltip:
      "Stand C: Enheden har synlige brugsspor. Fuldt funktionel og bedste pris.",
    color: "text-gray",
    bg: "bg-gray/10",
  },
};
