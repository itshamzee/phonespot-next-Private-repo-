    ...
    <>
      <section className="border-b border-[#DDE2DD] bg-[#F4F5F2]">
        <div className="mx-auto max-w-7xl px-4 py-7 sm:py-10">
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,2fr)_minmax(18rem,1fr)] lg:items-end">
            <div>
              <h1 className="font-sans text-3xl font-semibold leading-tight tracking-[-0.04em] text-[#202421] sm:text-5xl">
                {title}
              </h1>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid gap-8 lg:grid-cols-[minmax(16rem,0.75fr)_minmax(0,1.5fr)]">
            <div>
              ...
              <h2 className="mt-2 font-sans text-3xl font-semibold tracking-[-0.035em] text-[#202421]">Hvad betyder standen?</h2>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(18rem,0.85fr)]">
            <div>
              ...
              <h2 className="mt-2 font-sans text-3xl font-semibold tracking-[-0.035em] text-[#202421]">{guideTitle}</h2>
              ...
              <div className="mt-8 divide-y divide-[#DDE2DD] border-y border-[#DDE2DD]">
                {choices.map((choice, index) => (
                  <div key={choice.title} className="grid gap-2 py-5 sm:grid-cols-[2rem_10rem_minmax(0,1fr)] sm:gap-4">
                    ...
                    <h3 className="font-sans text-sm font-semibold text-[#202421]">{choice.title}</h3>
            ...
            <aside className="self-start rounded-lg bg-[#1A3D2E] p-7 text-white">
              ...
              <h2 className="mt-2 font-sans text-3xl font-semibold tracking-[-0.035em]">Se den. Prøv den. Tag den med.</h2>
              ...
              <div className="mt-7 divide-y divide-white/20 border-y border-white/20">
                <Link href="/butikker/vejle" className="flex min-h-12 items-center justify-between text-sm font-semibold">PhoneSpot Vejle <span aria-hidden="true">→</span></Link>
                <Link href="/butikker/slagelse" className="flex min-h-12 items-center justify-between text-sm font-semibold">PhoneSpot Slagelse <span aria-hidden="true">→</span></Link>
              </div>
      ...
      <section className="border-t border-[#DDE2DD] bg-[#F4F5F2] py-12 sm:py-16">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 lg:grid-cols-[minmax(14rem,0.7fr)_minmax(0,1.3fr)]">
          <div><p className="text-xs font-semibold text-[#1A3D2E]">Spørgsmål og svar</p><h2 className="mt-2 font-sans text-3xl font-semibold tracking-[-0.035em] text-[#202421]">{guideTitle}</h2></div>
